...
res.render('index', { title: 'Elephants App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Elephants App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Elephants App Login', user : req.user });
  });
